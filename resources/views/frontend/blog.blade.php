          ...
          <div class="row">
            <div class="col-md-8">
              <div class="blog-listing">
                ...
                <article class="post">
                  <div class="media">
                    <a href="{{ route('blog.detail', ['slug' => $post->slug, 'category' => $post->category->slug]) }}"> <img src="{{ Voyager::image($post->image) }}" alt="{{ $post->title }}"> </a>
                  </div>
                  <header class="header">
                    <h4><a href="{{ route('blog.detail', ['slug' => $post->slug, 'category' => $post->category->slug]) }}">{{ $post->title }}</a></h4>
                    ...
                    <div class="excerpt">
                      ...
                      <a href="{{ route('blog.detail', ['slug' => $post->slug, 'category' => $post->category->slug]) }}" class="btn">Read more </a>
                    </div>
                  </header>
                </article>
                @endforeach
                ...
                <div class="mccan-sidebar-block mccan-sidebar-block-latest-posts animate-box fadeInLeft animated" data-animate-effect="fadeInLeft">
                  ...
                  <div class="mccan-sidebar-block-content">
                    <div class="latest">
                      ...
                      <a href="{{ route('blog.detail',['slug' => $f->slug, 'category' => $f->category->slug]) }}" class="clearfix">
